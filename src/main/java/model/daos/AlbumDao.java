...
public class AlbumDao {
	...
	try (
		...
		PreparedStatement preparedStatement = dbConnection.prepareStatement(QUERY_GETALLBYGENRE);
	...
	try (
		Connection dbConnection = ConnectionManager.getConnection(); 
		PreparedStatement preparedStatement = dbConnection.prepareStatement(QUERY_GETNUMBERUSERALBUMS_VIEW);) {
    ...
    */
	...
	try (
		Connection dbConnection = ConnectionManager.getConnection(); 
		PreparedStatement preparedStatement = dbConnection.prepareStatement(QUERY_GETBYID_CHECKING_USER);) {
	...
	try (
		Connection dbConnection = ConnectionManager.getConnection(); 
		PreparedStatement preparedStatement = dbConnection.prepareStatement(QUERY_UPDATE_CHECKING_USER);) {	    
