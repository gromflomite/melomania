 ...
 * @author gromflomite
 * 
 * This is the first element called at web charge (called from WEB-INF/web.xml).
 * 
 *  The function of this controller is to show a collage of albums into the frontpage. User is able to ch
 *
 */
@WebServlet("/home")
public class HomeController extends HttpServlet {
	...
	/**
	 * 
	 * THIS CONTROLLER IS THE FIRST THING CALLED AT WEB CHARGE (called from WEB-INF/web.xml)
	 * 
